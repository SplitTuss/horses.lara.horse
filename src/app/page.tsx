  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center">
        ...
        <div className="max-w-sm sm:max-w-2xl text-md sm:text-4xl flex text-center text-purple-300 relative mx-4 mt-40 sm:mt-90 mb-6 sm:mb-80 opacity-70 sm:opacity-50">
